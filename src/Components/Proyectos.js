...
const Proyectos = () => {
    return (
        <>
            <h1 className="heading-1 proyectos-h1">Proyectos</h1>
            <section class="proyectos" id="proyectos">

                <h3 className="heading-3">Custom-Cards:</h3>
                <p className="descripcion">Una app que consume la api de pixabay.com permitiendo traer imágenes de una determinada categoría para elegir una y crear una tarjeta personalizada con la misma.</p>
